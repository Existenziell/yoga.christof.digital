        ...
        <nav>
            ...
            <div className='absolute right-4 top-4'>
                {!darkMode ?
                    ...
                    :
                    <svg onClick={() => toggleDarkMode('light')} xmlns='http://www.w3.org/2000/svg' className='h-8 w-8 text-gray-500 dark:text-gray-200 cursor-pointer hover:opacity-70' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
            ...
            <div className='absolute left-4 top-4'>
                <button className='mobile-menu-button outline-none' onClick={() => setIsOpen(!isOpen)} aria-label='Open Mobile Navigation'>
                    {!isOpen ?
                        ...
                        :
                        <svg xmlns='http://www.w3.org/2000/svg' className='z-10 absolute top-0 left-0 h-12 w-12 hover:text-brand text-black dark:text-gray-300' fill='none' viewBox='0 0 24 24' stroke='currentColor'>

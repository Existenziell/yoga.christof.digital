    ...
    <section>
      <div className='absolute right-4 top-4'>
        {!darkMode ?
          ...
          :
          <svg onClick={() => toggleDarkMode('light')} xmlns='http://www.w3.org/2000/svg' className='h-10 w-10 text-gray-500 cursor-pointer hover:text-brand' fill='none' viewBox='0 0 24 24' stroke='currentColor'>

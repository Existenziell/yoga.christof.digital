  ...
  return (
    <>
      ...
      <div className='max-w-xl m-auto px-4 leading-relaxed my-16' id='anchor'>
        ...
        <p className='mt-12 mb-2 text-2xl'>Hi, I am Christof &#x2661;</p>
        <div>
          <p>
            ...
            The name shift_happens was the perfect fit for what I was experiencing during that time and still am today.{' '}
